...
public class eventosSQLite extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table eventosInscritos(idEvento String primary key,  Nombre String, Fecha String, Hora String, Ubicacion String, Ponente String, Descripcion String)");
    }
